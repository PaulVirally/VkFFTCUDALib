...
extern "C" VkFFTConfiguration* new_config(const pfUINT fftdim, const pfUINT buffer_dim, const pfUINT* size, const pfUINT* omit_dims, const pfUINT num_batches, const pfUINT coalesced_memory, const pfUINT aimThreads, const pfUINT numSharedBanks, const bool forward, const bool use_double_precision, const bool inplace);
